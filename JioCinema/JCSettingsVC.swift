...
//            }
    ...
    override func didUpdateFocus(in context: UIFocusUpdateContext, with coordinator: UIFocusAnimationCoordinator) {
        ...
        if let nextFocussedCell = context.nextFocusedView as? JCSettingsTableViewCell {
            ...
            nextFocussedCell.textLabel?.textColor = ViewColor.selectionBarOnLeftNavigationColor/*#colorLiteral(red: 0.8509803922, green: 0, blue: 0.5529411765, alpha: 1)*/
            nextFocussedCell.settingsDetailLabel.textColor = ViewColor.selectionBarOnLeftNavigationColor/*#colorLiteral(red: 0.8509803922, green: 0, blue: 0.5529411765, alpha: 1)*/
            nextFocussedCell.cellAccessoryImage.image = #imageLiteral(resourceName: "ArrowPink.png").sd_tintedImage(with: ViewColor.selectionBarOnLeftNavigationColor)
