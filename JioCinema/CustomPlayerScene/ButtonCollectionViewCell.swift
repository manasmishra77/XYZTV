...
class ButtonCollectionViewCell: UICollectionViewCell {
    ...
    func configCellView(item: PlayerButtonItem) {
        ...
        playerButton.setTitle("\(item.unselectedImage ?? "")", for: .normal)
...
//            self.transform = CGAffineTransform(scaleX: 1.2, y: 1.2)
            ...
            if self.buttonTitle.text == "Play" || self.buttonTitle.text == "Pause"{
                ...
                playerButton.setTitle("\(buttonItem?.selectedImage ?? "")", for: .normal)
...
//            self.transform = CGAffineTransform(scaleX: 1.2, y: 1.2)
            ...
            if self.buttonTitle.text == "Play" || self.buttonTitle.text == "Pause"{
                ...
                playerButton.setTitle("\(buttonItem?.unselectedImage ?? "")", for: .normal)
